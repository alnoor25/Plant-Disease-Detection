...
DATADIR = "./plantvillage dataset/color/"
CATEGORIES = [ "Squash___Powdery_mildew"
          ]
...
for category in CATEGORIES:
    ...
    for img in os.listdir(path):
        ...
        break
    break
print(img_array.shape) # displays dimension of the dataset
IMG_SIZE = 224
...
#for coloured  3 , for gray it will be 1 . here (3) 
